  ...
  return (
    <div className="rounded-2xl border border-[#FF9F6A]/25 bg-[linear-gradient(160deg,#17100E,#090909)] p-5">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          <p className="text-xs font-bold uppercase tracking-[0.18em] text-[#FFB48A]">Audio</p>
          <h2 className="mt-2 font-display text-2xl font-black italic text-white">Leclerc clip</h2>
        </div>
        <button
          type="button"
          onClick={toggleAudio}
          className="inline-flex min-h-11 items-center gap-2 rounded-full border border-[#FF9F6A]/35 bg-black/30 px-4 py-2 text-xs font-bold uppercase tracking-[0.16em] text-white transition-colors hover:border-[#FF9F6A]/60"
        >
